  ...
  return (
    <div key={room.id}>
      ...
      <div className="mt-1 text-sm">
        ...
        <span className="text-grey-500">/박</span>
      </div>
    </div>
  )
}
...
export function GridLayout({ children }: { children: ReactNode }) {
  return (
    <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-2 sm:px-4 md:px-8 lg:px-16">
      {children}
    </div>
  )
}
