  ...
  return (
    ...
    >
      <div className="grow basis-0 hidden font-semibold text-lg sm:text-xl text-rose-500 cursor-pointer sm:flex sm:gap-2">
        ...
        <div className="my-auto">Next bnb</div>
      </div>
      {showFilter === false ? (
        <div className="w-full sm:w-[340px] border py-1.5 border-gray-200 rounded-full shadow hover:shadow-lg cursor-pointer flex justify-between pl-6 pr-2">
          <div
            role="presentation"
          ...
          >
            ...
            <RxDividerVertical className="text-gray-200 my-auto text-2xl" />
            <div className="my-auto font-semibold text-sm">게스트 추가</div>
          </div>
          <button
            type="button"
            onClick={() => setShowFilter(true)}
